...
public class InfernumBlockBlock extends Block {
	...
	public static void clientInit() {
		BlockRenderLayerMap.INSTANCE.putBlock(DefconttwoModBlocks.INFERNUM_BLOCK, RenderType.solid());
	}
}
