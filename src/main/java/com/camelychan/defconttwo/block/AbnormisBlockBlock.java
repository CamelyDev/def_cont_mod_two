...
public class AbnormisBlockBlock extends Block {
	...
	public static void clientInit() {
		BlockRenderLayerMap.INSTANCE.putBlock(DefconttwoModBlocks.ABNORMIS_BLOCK, RenderType.solid());
	}
}
