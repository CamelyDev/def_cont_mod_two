...
public class AdstutusBlockBlock extends Block {
	...
	public static void clientInit() {
		BlockRenderLayerMap.INSTANCE.putBlock(DefconttwoModBlocks.ADSTUTUS_BLOCK, RenderType.solid());
	}
}
