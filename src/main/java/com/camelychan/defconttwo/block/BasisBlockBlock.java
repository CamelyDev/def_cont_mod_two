...
public class BasisBlockBlock extends Block {
	...
	public static void clientInit() {
		BlockRenderLayerMap.INSTANCE.putBlock(DefconttwoModBlocks.BASIS_BLOCK, RenderType.solid());
	}
}
