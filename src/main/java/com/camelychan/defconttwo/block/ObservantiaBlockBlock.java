...
public class ObservantiaBlockBlock extends Block {
	...
	public static void clientInit() {
		BlockRenderLayerMap.INSTANCE.putBlock(DefconttwoModBlocks.OBSERVANTIA_BLOCK, RenderType.solid());
	}
}
